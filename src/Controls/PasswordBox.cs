...
public class PasswordBox : Control
{
    ...
    public static readonly DependencyProperty ShowPasswordProperty =
        DependencyProperty.Register(nameof(ShowPassword), typeof(bool), typeof(PasswordBox), new PropertyMetadata(false));

    public static readonly DependencyProperty PlaceholderProperty =
        DependencyProperty.Register(nameof(Placeholder), typeof(string), typeof(PasswordBox), new PropertyMetadata(null));

    public static readonly DependencyProperty RevealButtonProperty =
        DependencyProperty.Register(nameof(RevealButton), typeof(bool), typeof(PasswordBox), new PropertyMetadata(true));

    private static readonly DependencyPropertyKey HasTextPropertyKey =
        DependencyProperty.RegisterReadOnly(nameof(HasText), typeof(bool), typeof(PasswordBox), new PropertyMetadata(false));
    ...
    private void OnPasswordBoxChanged(object sender, RoutedEventArgs e) => SetValue(PasswordProperty, _passwordBox!.Password);
